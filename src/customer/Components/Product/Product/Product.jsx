                  ...
                  <Menu.Items className="absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div className="py-1">
                      {sortOptions.map((option) => (
                        ...
                        {/* This is a function that receives an object with an active property. This function is used to render the content of the menu item.
                        The active property is a boolean that indicates whether the menu item is currently highlighted or selected */}
                          {({ active }) => (
                            <p
