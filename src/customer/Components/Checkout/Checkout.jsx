...
console.log("step",step)
  ...
  //the function handles moving to the next step and makes sure that any step that was marked as skipped is properly updated when moving forward.
  const handleNext = () => {
        ...
        {steps.map((label, index) => {
          ...
          return (
            ...
            <Step key={label} {...stepProps}>
              {/* StepLabel Component: Provides a label for the step. */}
