...
//The function addItemToCart = (reqData) => async (dispatch) => { ... } is a Redux Thunk action creator, used to manage asynchronous operations like API calls in a Redux environment.
